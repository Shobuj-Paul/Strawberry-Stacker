...
## Procedure
- Write a python script named _pick_n_place.py_ in the scripts folder and create a rosnode named _pick_n_place_ in this python script.
...
## Procedure
- Write a python script named _pick_n_place_aruco.py_ in the scripts folder and create a rosnode named _pick_n_place_aruco_ in this python script.
- Launch the Gazebo world by typing the following command in a terminal
```bash
